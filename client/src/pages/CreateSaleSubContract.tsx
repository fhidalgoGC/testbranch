...
export default function CreateSaleSubContract() {
    ...
    const loadContractData = async () => {
      ...
      try {
        ...
        if (foundContract) {
          ...
          // Set open inventory
          const openInventoryValue = foundContract.inventory?.open || foundContract.quantity || 0;
  ...
  useEffect(() => {
    ...
    console.log('💰 Price calculation:', { future, basis, quantity, calculatedPrice });
  ...
  const confirmSubmit = async () => {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : 'Failed to create sub-contract');
    } finally {
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <Controller
                    ...
                    control={control}
                    render={({ field }) => (
                      <Input {...field} type="date" disabled className="bg-gray-50 dark:bg-gray-800" />
                    )}
                  />
                </div>
                <div>
                  ...
                  <Controller
                    ...
                    control={control}
                    render={({ field }) => (
                      <Input {...field} disabled className="bg-gray-50 dark:bg-gray-800" />
                    )}
                  />
                </div>
                <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <Select value={field.value} onValueChange={field.onChange}>
                        <SelectTrigger className={errors.measurementUnitId ? 'border-red-500' : ''}>
                  ...
                  {errors.measurementUnitId && (
                    <p className="text-sm text-red-500 mt-1">{errors.measurementUnitId.message}</p>
                  )}
                </div>
              </div>
            </CardContent>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  />
                  {errors.basis && (
                    <p className="text-sm text-red-500 mt-1">{errors.basis.message}</p>
                  )}
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-1 gap-4">
                <div>
                  ...
                  />
                  {errors.totalDate && (
                    <p className="text-sm text-red-500 mt-1">{errors.totalDate.message}</p>
                  )}
                </div>
              </div>
            </CardContent>
            ...
            <div className="py-4">
              <div className="space-y-2">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">{watch('quantity')} {measurementUnits.find(u => u.value === watch('measurementUnitId'))?.label || ''}</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  <span className="text-gray-600 dark:text-gray-400">{t('deliveryDate')}:</span>
                  <span className="font-medium">{new Date(watch('totalDate')).toLocaleDateString()}</span>
                </div>
              </div>
            </div>
